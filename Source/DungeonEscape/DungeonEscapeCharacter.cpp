...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Move Fast Started
		EnhancedInputComponent->BindAction(MoveFastAction, ETriggerEvent::Started, this, &ADungeonEscapeCharacter::MoveFastStarted);

		// Move Fast Ending
		EnhancedInputComponent->BindAction(MoveFastAction, ETriggerEvent::Completed, this, &ADungeonEscapeCharacter::MoveFastEnding);
	}
	else
	{
